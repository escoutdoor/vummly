const articles = [
		...
		data: [
			{
				text: [
					{
						textline:
							"Yes. You'll need to redeem your Nift gift card and choose your gift within 30 days of activation.",
					},
					{
						textline:
							'Participating businesses may have separate expiration dates that apply towards redeeming your chosen gift, so be sure to check your selected offer.',
					},
				],
			},
		],
		...
		data: [
			{
				text: [
					{
						textline:
							'Nift takes privacy very seriously and doesn’t share your information with anyone. You can ask Nift to delete your personal information from the system at any time. Read more about our Privacy Policy here.',
					},
				],
			},
		],
	},
	{
		...
		data: [
			{ text: [{ textline: "No problem! We've got you covered either way." }] },
			{
				points: [
					{
						bold: 'Gifts under $30:',
						point: 'If the gift you choose is under $30, you’ll get an additional Nift email with your balance — so, for example, you could have a $10 pizza on us and receive a $20 gift certificate toward skincare products.',
					},
					{
						bold: 'Gifts over $30:',
						point: "If Nift member businesses offer gifts of a higher value, they'll cover the difference so you don’t pay more than $30 — for example, if you’re offered a $50 gift, $20 is a bonus paid for by the retailer. ",
					},
				],
			},
		],
		...
		data: [
			{
				text: [
					{
						textline:
							"The gifts available through the invitation-only Nift Network are exclusive, limited in quantity, and vary by location. Nift curates a list of up-and-coming businesses to help you discover brands you won't find at large retailers such as Amazon, Target, or Walmart.",
					},
				],
			},
		],
	},
	{
		...
		data: [
			{ text: [{ textline: 'Redeeming your gift card is easy!' }] },
			{
				points: [
					{ point: 'Get your Nift gift code by email' },
					{ point: 'Click the link in the email to enter your code then' },
					{
						point: 'Follow the prompts to personalize your shopping preferences and get matched with a gift.',
					},
					{ point: 'Not seeing anything you like? Click reset or go back to change your preferences.' },
				],
			},
			{
				text: [
				...
				points: [
					{
						bold: 'In person:',
						point: 'Present the Nift certificate on your phone at checkout, then tap Redeem. ',
					},
					{
						bold: 'Online:',
						point: 'Select the link to the retailer’s site in your email, and enter your unique promo code.',
					},
				],
			},
		...
		data: [
			{
				text: [
					{
						textline:
							'A Nift gift card is a special gift that is a great way to try new products, services and places that are part of the Nift Network. Depending on your interests and your location, you may be matched with the opportunity to to use your gift card for:',
					},
				],
			},
			{
			...
			},
			{
				text: [
					{
						textline:
							"Vummly annual subscribers receive a $30 Nift gift card as a small “thank you” for being a valued part of the Vummly community. Your Nift gift card can't be used for Vummly products and services.",
					},
				],
			},
		],
