...
const articles = [
    {
        "idPage": "contact-us",
        "title": "Contact us",
        "way": [{ "wayname": "Smart Thermometer", "link": "categories/thermometer"}], 
        "data": [{ "text": [{ "textline": "Have any issues, questions, or feedback about anything in Yummly?"}]}, { "text": [{"textline": "Please Email us and one of our Support Team members will get right back to you."}]}, { "text": [{ "textline": "Our email : ", "mail": "support@yummly.com"}]}]
    },
    {
...

    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": "Let's try a couple of troubleshooting steps that fix most issues."}]}, { "points": [{ "point": 'Try a fresh set of batteries in the dock. Remove the Thermometer from the dock (the dock lights should come on) and place it back in (this will start the charging process). Let the Thermometer charge for 60 minutes.'}, { "point": 'When charging the Thermometer in the Dock make sure that the top of the thermometer and the charging prong on the dock are clean, and make strong contact with each other. You may want to try slightly bending the charging prong on the Dock to ensure contact.'}, { "point": "Make sure that Bluetooth on your device is turned on, and that Yummly is able to access Bluetooth in your phone's Settings."}, { "point": "Let's reset the Thermometer and connection:"}, { "point": 'In the Yummly app, go to "My Connected Kitchen" > tap the "..." menu icon > tap "Disconnect Thermometer"'}, { "image": [{ "img": '/not-found.jpg'}] }, { "point": 'On your phone go to Bluetooth settings and forget/delete "Yummly T1" if possible. If not listed, proceed to the next step.'}, { "point": 'Remove the thermometer from the dock. Hold the button on top of the dock for 5 seconds until the lights on the dock turn off.  Replace the thermometer in the dock.'}, { "point": 'Turn off your phone and restart'}, { "point": 'Try to reconnect the Smart Thermometer to the Yummly app by following the prompts in the app (Thermometer must be out of the Dock to pair)'}]}, { "text": [{ "textline": 'If you are still unable to connect, please email us at', "mail":'support@yummly.com'}] }]
    },
...

    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": 'The Yummly app should automatically attempt to reconnect. Bring your mobile device closer to the docking station. Keep the docking station as close to the Smart Thermometer as possible, avoiding direct heat. If the disconnection is sustained, check that the docking station and thermometer are charged. If you are in the process of cooking, attempt to reset the connection.'}]}, { "points": [{ "point": 'On your mobile device go to the Bluetooth settings and forget/delete Smart Thermometer if possible'}, { "point": 'Press and hold the button at the top of the dock for 3 seconds (the lights will turn off and back on again)'}, { "point": 'The green light will come on and the blue light will pulse slowly until the device reconnects'}]}]
    },
    
    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": "iOS and Android :"}]}, { "points": [{ "bold": 'Remove', "point": 'thermometer from its dock (ensure there are batteries in the dock with power)'}, { "point": 'In the Yummly app, go to "My Connected Kitchen" > tap the "..." menu icon > tap "Disconnect Thermometer"'}, { "point": 'On your iPhone go to the Bluetooth settings and forget/delete "Yummly T1"'}, { "point": 'Hold button on top of dock for 5 seconds (the lights will turn off and back on again)'},{ "point": 'Turn off your phone and restart'}, { "point": 'Reconnect the Smart Thermometer to the Yummly app'}]}]
    },
...

    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": 'The docking station has two purposes:'}]}, { "points": [{ "bold": 'Charging', "point": '– the docking station recharges Smart Thermometer when it’s placed in its cradle.'}, { "bold": 'Connecting', "point": '– Smart Thermometer connects to the docking station, then the docking station connects to your mobile device/Yummly app. The docking station should remain very close to Smart Thermometer to stay connected, but you can use your phone up to 150ft from the docking station.'}]}]
    },
...

    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": 'Open the Yummly app > tap My Connected Kitchen icon >'}, { "textline": 'Open the Yummly app > tap My Connected Kitchen icon >'}, { "textline": 'On the Smart Thermometer card tap the “...” icon in the upper right corner of the Smart Thermometer tab.'}, { "textline": 'There are no lights on the dock when the thermometer is charging.'}, { "image": [{ "img": 'not-found.jpg'}]}]}]
    },
...

    {
        ...
        "title": "Can I air fry?",
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": 'Yes! Yummly Smart Thermometer is great for air frying, handling temperatures of up to 570f and internal meat temperatures up to 200f. Be sure to keep the dock next to your air fryer for continuous temperature monitoring while you cook.'}]}]
    },
...

    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": 'Yes! Yummly Smart Thermometer is great for grilling, handling grill temperatures of up to 572f and internal meat temperatures up to 200f. Be sure to keep the dock next to your grill for continuous temperature monitoring while you cook.'}],}]
    },
    ...
    {
        "idPage": 'is-yummly-app-free',
        "title": "Is the Yummly® app free?",
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": 'The Yummly app is free to download, and you can use the thermometer controls in the app without a paid subscription.'}, { "textline": 'Yummly also has millions of recipes that you can search and save into your account for free.  You can use the Yummly bookmarklet to add recipes from around the internet to your saved recipes for free.'}, { "textline": 'You can log into this same free account on multiple devices and our website.'}, { "textline": 'Yummly does offer a subscription service that allows you access to exclusive recipes and features.'}, { "textline": 'You can learn more about the subscription service here:', "link": 'https://github.com/OrynHydro'}]}]
    },

    {
        "idPage": 'where-i-can-download-yummly-app',
        "title": "Where can I download the Yummly app?",
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": 'You can download Yummly for free here:'}, { "textline": "Apple App Store: ", "link": 'https://github.com/OrynHydro'}, { "textline": "Google Play Store: ", "link": 'https://github.com/OrynHydro'}]}]
    },

    {
        "idPage": 'do-i-need-to-use-yummly-app-with-thermometer',
        "title": "Do I need to use the Yummly app with the Smart Thermometer?",
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": 'Yes, the Smart Thermometer requires and works with the Yummly app to display temperature, calculate cooking times, and get you the desired results. You can download Yummly for free here:'}, { "textline": "Apple App Store: ", "link": 'https://github.com/OrynHydro'}, { "textline": "Google Play Store: ", "link": 'https://github.com/OrynHydro'}]}]
    },
...

    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": 'Smart Thermometer works with the Yummly app which requires Android 7.0 or newer. To update your Android device, follow these instructions:'}]}, { "points": [{  "point": "Open your phone's Settings app."}, {  "point": 'Near the bottom, tap System and then Advanced and then System update.'}, {  "point": "You'll see your update status. Follow any steps on the screen."}]}]
    },

    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "points": [{ "point": "Open the Yummly app and go to your Connected Kitchen (the oven icon in the lower right-hand corner of your screen)"}, {  "point": 'At the bottom of this screen, tap Add Appliance'}, { "image": [{ "img": 'How to add multiple thermometers.jpg'}]}, { "point": 'Add one thermometer at a time. After one thermometer is added, you can add another appliance. You can connect up to four thermometers.'}, { "point": 'Connect one thermometer at a time.'}]}]
    },
    ...
    {
        "idPage": 'reconnect-more-than-one-yummly-start-thermometer-at-a-time',
...

    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": "When you purchase the Smart Thermometer you will receive an order confirmation email. You will then receive a shipment email with tracking information once the package has shipped. If you don't get either of these emails, please reach out to us at", "mail": 'support@yummly.com.'}] }]
    },

    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": "The Yummly Smart Thermometer can be returned up to 30 days from purchase when bought on Yummly.com. If purchased elsewhere, please refer to the retailers return policy."}, { "textline": 'To start a return with Yummly, contact us: ',  "mail": 'support@yummly.com.'}]}]
    },
...

    {
        ...
        "way": [{ "wayname": 'Smart Thermometer', "link": "categories/thermometer"}],
        "data": [{ "text": [{ "textline": "iOS", "fontweight": 700}, { "textline": 'The Yummly Smart Thermometer requires the Yummly app on iOS 13 or newer.'},{ "textline": 'Yummly for iOS is a free download', "link": 'https://github.com/OrynHydro'}, { "textline": "Android", "fontweight": 700}, { "textline": 'The Yummly Smart Thermometer requires the Yummly app on Android 6.0 or newer.'},{ "textline": 'Yummly for Android is a free download', "link": 'https://github.com/OrynHydro'}]}]
    },

    {
        "idPage": 'including-sub',
        "title": "What's included in my Yummly subscription?",
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "We're glad you asked! With a paid subscription to Yummly, you'll have full access to all of our cutting-edge features designed to help you cook smarter. "}]}]
    },
...

    {
        ...
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "No. The Yummly Smart Thermometer is available for purchase separately, and requires no subscription to use."}, ]}]
    },

    {
        ...
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "No. The Yummly app is free to download, and you can use the thermometer controls in the app without a paid subscription."}, ]}]
    },

    {
        ...
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "At this point in time, Yummly's subscription features are only available in the U.S. We look forward to expanding our offerings internationally in the future."}, ]}]
    },
...

    {
        ...
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "You can cancel your subscription to Yummly for any reason, at any time — but be sure to cancel at least 24 hours before the end of your billing cycle to end your subscription and avoid charges for the upcoming cycle. Click the method you used to subscribe from the list below to get specific cancellation instructions."}]}]
    },

    {
        "idPage": "sub-cost",
        "title": "How much does a Yummly subscription cost?",
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "Standard non-promotional pricing for a Yummly subscription is $4.99/month. If you’re taking advantage of a free trial period offer, then your Yummly subscription will be free during that period. After the trial period ends, your Yummly subscription will auto-renew at your selected price unless you cancel. You can cancel any time (for any reason) — but you’ll need to do so at least 24 hours before the end of your trial or renewal date to avoid charges."}, { "textline": '* Subscription only available in the U.S. We look forward to expanding our offerings internationally in the future.', "fontstyle": 'italic'}]}]
    },

    {
        ...
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{  "text": [{ "textline": "Nope! You won't be charged if you cancel before the trial period ends — just do so 24 hours before the end of your trial to avoid charges.  If you don't cancel, Yummly will bill you the day after your trial expires. Check your Account Settings for pointails."}]}]
    },
...

    {
        ...
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "Yes, Yummly paid subscriptions automatically renew each billing cycle (the cycle is based on your sign-up date) until you cancel. You'll get an email receipt for each billing cycle of your renewal."}, { "textline": "You can cancel your subscription to Yummly at any time, for any reason — but be sure to cancel at least 24 hours before the end of your billing cycle to end your subscription and avoid charges for the upcoming cycle."}]}]
    },
    ...
    {
        "idPage": "what-are-yummly-pro-recipes",
        "title": "What are Yummly Pro recipes?",
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "Yummly Pro recipes are a one-of-a-kind cooking experience that's included with a paid subscription to Yummly. Pro features the world’s best culinary professionals in an immersive, intimate, step-by-step video format on Yummly that's optimized for cooking. Perfect for both new and experienced cooks, you'll get hands-on training by renowned professional chefs taken at your own pace to help you become a better cook."}]}]
    },

    {
        "idPage": "how-do-yummly-pro-videos-work",
        "title": "How do Yummly Pro videos work?",
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "Yummly Pro recipes' unique format lets you move through recipes at your own pace. Each step is presented one at a time with video and relevant text. Pro doesn't move on to the next step in a recipe until you're ready."}]}]
    },

    {
        "idPage": "do-yummly-pro-recipes-work-on-my-device",
        "title": "Do Yummly Pro recipes work on my device?",
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "Yummly Pro recipes work on the web for PCs, laptops, and tablets. On smartphones, Pro recipes can also be accessed through the Yummly app."}]}]
    },
...

    {
        ...
        "way": [{ "wayname": 'Yummly Paid Subscription', "link": 'categories/sub'}],
        "data": [{ "text": [{ "textline": "A Nift gift card is a special gift that is a great way to try new products, services and places that are part of the Nift Network. Depending on your interests and your location, you may be matched with the opportunity to to use your gift card for:"}]}, { "points": [{ "point": 'Wine'}, { "point": 'Food delivery'}, { "point": 'Clothing'}, { "point": 'Restaurants'}, { "point": 'Spas'}, { "point": 'Gyms'}, { "point": 'And more!'}]}, { "text": [{ "textline": "Yummly annual subscribers receive a $30 Nift gift card as a small “thank you” for being a valued part of the Yummly community. Your Nift gift card can't be used for Yummly products and services."}]}]
    },

    {
        "idPage": "what-is-yummly",
        "title": "What is Yummly?",
        "way": [{ "wayname": 'Website Help Topics', "link": 'categories/website-help-topics'}],
        "data": [{ "text": [{ "textline": "Yummly is the recipe app and site that learns what you like. With over 2 million recipes and food related articles and videos, it's the ultimate kitchen tool for your computer, iPhone, iPad & Android devices. Whether it’s finding a recipe, meal planning or taking a digital grocery list to the store, Yummly makes it easier for foodies to do what they love – discover, cook, eat and share!"}, { "textline": 'See how the website works:', "link": 'yummly.com/how-it-works'}, { "textline": 'Learn more about our apps:', "link": 'yummly.com/mobile'}]}]
    },

    {
        "idPage": "how-to-use-yummly",
        "title": "How to use Yummly",
        "way": [{ "wayname": 'Website Help Topics', "link": 'categories/website-help-topics'}],
        "data": [{  "text": [{ "textline": "Yummly is available on the web and via our mobile apps (iPhone, iPad & Android). Access the most powerful recipe search, your digital recipe box & recipe recommendations just for you."}, { "bigImage": [{ "img": 'how-to-use-yummly1.png'}, { "img": 'how-to-use-yummly2.png'}]}]},{  "text": [{ "textline": "Get started by signing up and setting up your taste profile with your unique preferences, diets, and allergies — and we’ll only serve up recipes that match your criteria."}, { "textline": "See more about how the site works:", "link": 'yummly.com/how-it-works'}]}]
    },

    {
        "idPage": "adding-recipes-to-yummly-from-other-sites",
        "title": "Adding recipes to Yummly from other sites",
        "way": [{ "wayname": 'Website Help Topics', "link": 'categories/website-help-topics'}],
        "data": [{ "text": [{ "textline": "There are millions of recipes available on Yummly, from the most popular food blogs and tasty recipe websites around. We are the largest and most powerful recipe search website."}, { "textline": "Found a recipe that’s not available on Yummly? Add it to your recipe box instantly with the Yummly bookmarklet. Install the bookmarklet here:", "link": 'https://www.yummly.com/bookmarklet ', "bigImage": [{ "img": 'adding-recipes-to-yummly-from-other-sites.png'}]}, { "textline": "Have your own recipe blog? Get your recipes on Yummly! Add the Yum button to your site to allow your readers to save your recipes to their Yummly recipe box. Once yummed, any recipe on your blog will be added to Yummly and searchable to our over 15 million monthly website and app users! The more Yums on your recipes, the more traffic and visibility they will get."}]}]
    },
    ...
    },
    {
        ...
        "way": [{ "wayname": 'Website Help Topics', "link": 'categories/website-help-topics'}],
        "data": [{ "text": [{ "textline": 'Yums are missing', "fontweight": 700}, { "textline": 'Don’t worry! You may have accidentally created a new account or signed in to a different one.'}, { "textline": 'If you created your account via Facebook or Google, make sure you are logged in to the correct account in your browser before logging in to Yummly.'}, { "textline": 'If you are signed in to the correct account, try:'}], "points": [{ "point": 'Logging out then logging in again to refresh your Yums'}, { "point": 'Closing your browser or using a different browser we support: Chrome, Firefox, Safari, or Internet Explorer 10 and above'}]}, { "text": [{ "textline": 'Still having issues?', "fontweight": 700}, { "textline":'If your Yums still aren’t showing up or you are having other issues, please submit a request. Make sure you include:'}], "points": [{ "point": 'The email address of your account'}, { "point": 'The device and browser you are using'}]}]
    },
    {
    ...
    },
    {
        ...
        "way": [{ "wayname": 'Website Help Topics', "link": 'categories/website-help-topics'}],
        "data": [{ "text":[{ "textline": 'Incorrect recipes come up after setting filters or taste preferences', "fontweight":700}, { "textline": "We may have imported the recipe information onto our site incorrectly. If a recipe came up in your search results or recipe recommendations when it shouldn't have, please submit a request. Make sure to include:"}], "points": [{ "point": 'The recipe name and link'},{ "point": 'What you searched for and the search filters you used'}, { "point": 'Why you believe the recipe came up in your search results incorrectly'}]}, { "text": [{ "textline": 'Yummly search results don’t match my Google search', "fontweight": 700}, { "textline": "We're aware of the issue and are actively working to resolve problems that appear when arriving from search engine results into Yummly."}, { "textline": "However, if you start your search in Yummly you can search across many of the major recipe sites and food blogs. You can then filter your results by excluding ingredients within your Yummly search using our unique search filters."}, { "textline": "We'd love for you to try searching within Yummly. We are building new functionality all the time and appreciate feedback — good and bad. You can share your feedback with us by submitting a request."}]}]
    },
    {
    ...
    },
    {
        ...
        "way": [{ "wayname": 'Website Help Topics', "link": 'categories/website-help-topics'}],
        "data": [{ "text": [{ "textline": 'You can edit your meal plan at any time.'}], "points": [{ "point": 'To remove a recipe, just click the "X" in the upper right-hand corner of the recipe card. To delete everything in your plan, select the "Clear All" button at the top of the page.'}, { "point": 'To add new recipes to the plan, either select the "Add Recipes" button to return to the Meal Planner recommendations page or use the button on any recipe page in Yummly to instantly add a recipe to your current plan.'}]}]
    },
    {
        "idPage": "meal-plan-adding",
        "title": "How do I add recipes to my Meal Plan on the website?",
        "way": [{ "wayname": 'Website Help Topics', "link": 'categories/website-help-topics'}],
        "data": [{ "text": [{ "textline": 'You can add recipes to your Plan in two ways:'}], "points": [{ "point": 'Open the Meal Planner to access your personalized recommendation feed. Just click the button on any recommended recipes you want to add to your Plan.'}, { "point": 'Open any recipe on Yummly, and find the icon. Click!'}]}]
    },
    {
        "idPage": 'loggining-in-to-the-website',
        "title": 'Logging in to the website',
        "way": [{ "wayname": 'Website Help Topics', "link": 'categories/website-help-topics'}],
        "data": [{ "text": [{ "textline": 'This article is about the website only. If you are looking for iOS or Android FAQs click here for:'}], "points": [{ "point": 'iOS', "link": '/support/articles/ios-sign-in-issue'}, { "point": 'Android', "link": '/support/articles/android-sign-in-issue'}]}, { "text": [{ "textline": 'Go to Yummly.com to create a free Yummly account.'}, {"bigImage": [{ "img": 'loggining-in-to-the-website.png' }]}]}, { "text": [{ "textline": "You'll need an account to use the majority of Yummly features on the website."}, { "textline": 'You can create an account or sign into your account via'}], "points": [{ "point": 'Email/password combo'}, { "point": 'Apple ID'}, { "point": 'Facebook'}, { "point": 'Google'}]}, { "text": [{ "textline":'If you are having any issues signing in, we sincerely apologize and ask you to email our support team for further assistance.'}, { "textline": 'You can do it there: ', "fontweight": 700, "mail": 'support@yummly.com'}]}]
    },
    {
        "idPage": 'your-profile',
        "title": 'Your profile',
    ...
    },
    {
        ...
        "way": [{ "wayname": 'Yummly iOS App', "link": 'categories/ios-app'}],
        "data": [{ "text": [{ "textline": 'Browse personalized recipe recommendations based on your profile and your Yums. Recommendations are available on the home screen of each mobile app.'}, { "textline": `To start receiving recipe recommendations, make sure you "Yum" at least five recipes. You'll also receive "Just for You" recipe recommendation emails.`}, { "textline": 'Every time you open the app or save a new recipe, you will receive new recipe recommendations!'}, { "textline": 'If you have a Yummly account and set your dietary preferences, your recommended recipes will be based on these. You can add disliked Ingredients, special diets, and allergies. To set your Dietary Preferences, go to Settings > Dietary Preferences.'}]}]
    },
    {
    ...
    },
    {
        ...
        "way": [{ "wayname": 'Yummly iOS App', "link": 'categories/ios-app'}],
        "data": [{ "text": [{ "textline": "Don't panic! Double check to make sure you are signed in to the correct Yummly account and restart your app. You may have accidentally created a new account."}, { "textline": 'You can sign in to your account on our website to ensure your saved recipes are still saved in your recipe box.'}, { "textline": 'If you created your Yummly account with your Facebook or Google+ account, make sure you are signed in to that account on your device before signing in to your Yummly account.'}]}]
    },
    {
        "idPage": 'ios-use-meal-planner',
        "title": 'How do I use the Yummly Meal Planner?',
        "way": [{ "wayname": 'Yummly iOS App', "link": 'categories/ios-app'}],
        "data": [{ "text": [{ "textline": 'Meal Planner can be accessed within the Plan & Shop section, indicated in the bottom navigation bar with the tasks icon.'}, { "textline": 'Step 1: Create Your Menu', "fontweight": 700}, { "textline": 'You can add a recipe to your Meal Plan from almost anywhere in the app, like your home feed, search results, collections and inside the recipe details page:'}, { "image": [{ "img": 'ios-use-meal-planner1.jpg'}, { "img": 'ios-use-meal-planner2.jpg'}, { "img": 'ios-use-meal-planner3.jpeg'}]}, { "textline": 'Step 2: Get Your Groceries', "fontweight": 700}, { "textline": 'Add ingredients to your Shopping List with a click, then take it on the go or get groceries delivered through Yummly.*'}, { "textline": '* Service available in select U.S. locations.', "fontstyle": 'italic'}, { "textline": 'Step 3: Cook, Review, Repeat!', "fontweight": 700}, { "textline": 'Get cooking, then review that recipe for even better recommendations. All done? Clear your Meal Plan and start your next culinary adventure!'}]}]
    },
    {
        "idPage": 'ios-find-meal-planner',
        "title": 'Where can I find the Meal Planner?',
        "way": [{ "wayname": 'Yummly iOS App', "link": 'categories/ios-app'}],
        "data": [{ "text": [{ "textline": 'Meal Planner is currently available on the Yummly website or in the Yummly app.'}, { "textline": 'For the full Meal Planner experience on the web, including personalized recommendations, select "Meal Planner" from the main Yummly.com navigation. Or, quickly access your customized Meal Plan from any page in Yummly by selecting the icon at the top of the screen.'},{ "textline": 'Within the Yummly app, the Meal Planner can be found within the Plan & Shop section, indicated in the bottom navigation bar with the navigation icon.'}]}]
    },
    {
        "idPage": 'ios-meal-recomm-from',
        "title": 'Where do my Meal Plan recommendations come from?',
        "way": [{ "wayname": 'Yummly iOS App', "link": 'categories/ios-app'}],
        "data": [{ "text": [{ "textline": "Yummly digs into our huge database of recipes to provide recommendations using a custom meal-planning algorithm that returns recipes just for you. For best results, make sure you've updated your taste preferences so we can give you more of what you like (and avoid those stinky brussels sprouts, if you want)."}, { "textline": `Remember, every time you rate a recipe, your recommendations get even better! Be sure to rate and review meals in your Meal Planner by clicking "Made It!" after you're done.`}]}]
    },
    {
    ...
    },
    {
        ...
        "way": [{ "wayname": 'Yummly iOS App', "link": 'categories/ios-app'}],
        "data": [{ "text": [{ "textline": 'Your Shopping List helps you keep all your grocery shopping needs organized. You can create and access it on your computer, phone, or tablet. Now, you always have your Shopping List on you!'}, { "textline": "It's flexible, too. "}], "points": [{ "point": 'Add ingredients with one click or tap from your Meal Plan or from any recipe on Yummly'}, { "point": 'Enter items manually by clicking Add to Shopping List in the Shopping List'}, { "point": 'Sort your Shopping List by recipe to streamline meal planning or by category to make shopping faster and easier'}]}, { "text": [{ "textline": 'Share your Shopping List with your family and friends through Email or Text Message by pressing the Share button at the top of the Shopping List.'}, { "textline": "Your Shopping List will sync between your devices as long as you're signed in to the same Yummly account. If your Shopping List isn't syncing, try the following:"}], "points": [{ "point": 'Make sure you are using the most updated version of our app on your devices'}, { "point": 'Restart the app'}, { "point": 'Double check to make sure you are signed in to the same Yummly account on your devices.'}]}]
    },
    {
        "idPage": 'ios-buy-ingr-yummly',
        "title": 'Can I buy ingredients through Yummly?',
        "way": [{ "wayname": 'Yummly iOS App', "link": 'categories/ios-app'}],
        "data": [{ "text": [{ "textline": 'Yes,'}], "points": [{ "point": 'click or tap Buy Now at the bottom of  your Shopping List'}, { "point": 'click the Buy icon on any Recipe Details Page'}]}, { "text": [{ "image": [{ "img": 'ios-buy-ingr-yummly.JPG'}]}, { "textline": 'Choose the Delivery provider and follow the prompts on the screen.'}, { "textline": 'The delivery list will populate for your Provider on the website inside the Yummly app, it will not populate the ingredients into another delivery app.'}, { "textline": 'If you have any issues with the Shopping List, please let us know at', "mail": 'Support@Yummly.com.'}]}]
    },
    {
        "idPage": 'ios-diff-devices-shopping-list',
        "title": 'Can I access my Shopping List on different devices?',
        "way": [{ "wayname": 'Yummly iOS App', "link": 'categories/ios-app'}],
        "data": [{ "text": [{ "textline": 'Absolutely. Your Shopping List syncs automatically across all your devices, including desktops, tablets, and phones. Make sure you have the Yummly app installed on your device and are logged in to your account.'}]}]
    },
    {
    ...
    },
    {
        ...
        "title": 'Home Feed',
        "way": [{ "wayname": 'Yummly Android App', "link": 'categories/android-app'}],
        "data": [{ "text": [{ "textline": 'Your home feed will show a variety of recipes labeled by category. If you’re signed into your account, you’ll see recipe recommendations based on your Yums and dietary preferences. To improve your recommendations, be sure to:'}], "points": [{ "point": 'Save at least five recipes (the more you Yum, the more helpful our recommendations become)'}, { "point": 'Set up your dietary preferences'}, { "point": "Review recipes you've made so we can get to know your tastes better"}]}, { "text": [{ "textline": 'Are your recipe recommendations too similar? Yum different types of recipes to get more varied recommendations.'}, { "textline": "Recipe recommendations don't match your dietary preferences? Check whether you’re signed into your Yummly account and make sure your dietary preferences are set."}]}]
    },
    {
        "idPage": 'android-sign-in-issue',
        "title": 'Sign-in issues',
        "way": [{ "wayname": 'Yummly Android App', "link": 'categories/android-app'}],
        "data": [{ "text": [{ "textline": 'Make sure you are signing in with the correct account you created your Yummly account with: Facebook, Google+, or Email.'}, { "textline": 'If you are unable to sign in to your account, make sure you have the most updated version of our app and try restarting the app then signing in again.'}, { "textline": 'Forgot your password?', "fontweight": 700}, { "textline": `You can get a reset password email sent to you from our website Yummly.com.  This cannot be done through the app at this time.  Go to Yummly.com and click Sign in. Enter your email address, and the password screen will appear with a "Forgot Password" Button at the bottom.  If you don't see the email in your inbox, double check your spam folder. Following the link provided in the email will allow you to reset your password and sign in to your account.`}]}, { "text": [{ "textline": "Can't sign in with your Facebook account?", "fontweight":700},{ "textline": 'Try resetting Yummly on your Facebook and restarting the app:'}], "points": [{ "point": 'Open Facebook and sign in to your account'}, { "point": 'Go to Settings > Apps > Remove Yummly from the list'}, { "point": 'Restart the Yummly app on your device'}, { "point": 'Sign in with your Facebook account'}] }]
    },
    {
        "idPage": 'android-recipe-search-results-issues',
        "title": 'Recipe search results',
        "way": [{ "wayname": 'Yummly Android App', "link": 'categories/android-app'}],
        "data": [{ "text": [{ "textline": "Were your search results different from what you're looking for?", "fontweight": 700}, { "textline": 'If you have a Yummly account, you can also set your Dietary Preferences which will always show you recipes based on your Disliked Ingredients, Diets, and Allergies. Make sure you do not have conflicting preferences (i.e. Vegetarian and Pescatarian.)'}, { "textline": 'If you see an error message when you click the Read Directions button, it may be a browser compatibility issue.'}, { "textline": 'Yummly works with the preferred browser on your device to open recipe directions.'},{ "textline": 'We recommend using Google Chrome as the preferred browser on your device, as it is the most compatible with the Yummly app for opening recipe directions.Go to the settings app on your phone and select Google Chrome as the preferred browser'}, { "image": [{ "img": 'android-recipe-search-results-issues.png'}]}]}]
    },
    {
    ...
    {
        "idPage": 'how-yummly-works',
        "title": 'How Yummly works',
        "way": [{ "wayname": 'Publisher Help Topics', "link": 'categories/publisher-help-topics'}],
        "data": [{ "text": [{ "textline": 'Yummly puts every recipe in the world in your pocket. The most powerful recipe search, the recipe sites you love, your digital recipe box, recipe recommendations just for you, and a smart shopping list — all with you wherever you go. Yummly has the #1 iPhone, iPad, and Android apps in addition to millions of website visitors. As recipes get more Yums, they get exposed more often throughout all of our platforms and features.'}, { "textline": 'How to get your recipes on Yummly', "fontweight": 700}, { "textline": 'The best "way" to get your recipes on Yummly is to add the Yum button to your blog or website. Once the Yum button is up, make sure you or your readers Yum your recipes so we can make sure to get them all on Yummly.'}, { "textline": 'Best practices to increase exposure', "fontweight": 700}, { "textline": 'More Yums on your recipes equals more traffic. Bloggers who educate their readers, encourage use of Yummly, and promote their Yummly publisher page see more Yums and more traffic. Volume of recipes is also a factor. More recipes on Yummly will lead to more referral traffic from us.'}, { "textline": 'Publisher pages on Yummly', "fontweight": 700}, { "textline": 'Currently, there is not an option for you to access and change your publisher page. In the meantime, we will update your page for you if you'},{ "textline": 'fill out this form:', "fontweight": 700, "link": 'https://github.com/escoutdoor'}, { "textline": 'Finding your publisher page', "fontweight": 700}, { "textline": "If you've added the Yum button and started yumming your recipes, a publisher page will be automatically created for your blog on Yummly. To find this, you can go to your personal user profile on Yummly and check to see if the recipe you Yummed has processed yet. Once it has processed, it will show a link on the recipe card to your publisher page. If you need help finding this page, email", "mail": 'vanap387@gmail.com'}]}]
    },
    {
        "idPage": 'get-discovered',
        "title": 'Get discovered even faster',
        "way": [{ "wayname": 'Publisher Help Topics', "link": 'categories/publisher-help-topics'}],
        "data": [{ "text": [{ "textline": 'Want your recipes on Yummly and the opportunity to have them featured in front of over 15 million monthly users on the site, in our #1 recipe apps, and in our emails and social media?'}, { "textline": 'FOLLOW THESE STEPS:', "fontweight": 700}], "points": [{ "bold": 'Add the Yum button to your blog.', "point": 'You can add it directly, via the Yummly recipe plugin, or via social sharing plugins like AddToAny, Shareaholic, or Simple Share buttons.'}, { "bold": 'Introduce your readers to Yummly!', "point": 'Share a post on your blog about being a publisher on Yummly and let your readers know that they can use the Yum button to save your recipes to their personal recipe box. Direct them to your Yummly publisher page so they can easily find and Yum your recipes.'}, { "bold": 'Tip:', "point": 'You want your readers to Yum your recipes because more Yums equals more eyes on your content and increased referral traffic to your site!'}, { "bold": 'Personalize your Publisher Page!', "point": "Once you've completed the above steps, you can add your social media links, a Profile picture, and a brief description of your site to Yummly by filling out this form."}]}]
    },
    {
        "idPage": 'best-practices-guidelines',
        "title": 'Best practices/guidelines',
        "way": [{ "wayname": 'Publisher Help Topics', "link": 'categories/publisher-help-topics'}],
        "data": [{ "text": [{ "textline": 'For most recipe sites, Yummly is often one of the top referral sources. Alongside the quality and popularity of a particular site, we also consider a few other factors that may affect a user’s experience negatively. Any one or combination of these factors can result in diminished or no referral traffic.'}, { "textline": 'iFrame:', "fontweight": 700}, { "textline": 'Yummly uses iFrame to display recipe directions. This works in the same "way" as Facebook, where the source page is loaded within the page the user is on in order to provide the best experience. Whenever a recipe page is loaded it functions just at it normally would, including driving traffic numbers. If a source site blocks iFrames then directions won’t display. In turn, these recipes sources may be shown less frequently or not at all on Yummly as they create an incomplete experience for the user.'}, { "textline": 'Popups:', "fontweight": 700}, { "textline": 'Should a site have aggressive popups, like those that cover a recipe entirely, are insistent on email subscriptions or social following, or that are ads, it will generally be considered not as great of a user experience. In turn, these recipe sources may be shown less frequently and/or rank lower in results on Yummly.'}, { "textline": 'Ads:', "fontweight": 700}, { "textline": 'While advertising is a necessity on most sites, advertising that appears gratuitously throughout the body of a recipe creating excess effort on the user’s part to get to the directions is considered a poor user experience. In turn, these recipe sources may be shown less frequently and/or rank lower in results on Yummly.'}, { "textline": 'Auto-play Videos:', "fontweight": 700}, { "textline": 'Videos located within the recipe that auto-play with the audio on that have little or nothing to do with the recipe are considered bad user experience. It will be considered whether videos are meaningful or seemingly included for ad impressions. These recipe sources may be shown less frequently and/or rank lower in results on Yummly.'}, { "textline": 'Bad translations:', "fontweight": 700}, { "textline": 'Recipes that appear to be poorly translated into English and/or are difficult to understand are not considered a good user experience. These recipe sources may be shown less frequently and/or rank lower in results on Yummly.'}]}]
    },
    {
        "idPage": 'yumm-butt-ur-site',
        "title": 'How to add the Yum button to your site',
        "way": [{ "wayname": 'Publisher Help Topics', "link": 'categories/publisher-help-topics'}],
        "data": [{ "text": [{ "textline": 'Follow the instructions below to add the Yum button:'}]}, { "text": [{ "textline": 'Blogger', "fontweight": 700}], "points": [{ "point": 'Copy the HTML code shown in the box on this page', "link": 'https://www.yummly.com/goodies/yumbutton?platform=blogger'}, { "point": 'Open your Blogger site editor tools & select ‘Template’ from the navigation options'}, { "point": "Select the ‘Edit HTML’ button from the Template page"}, { "point": 'Place your cursor anywhere inside the template HTML then select Command+F to display a Search box.'}, { "point": "Enter ‘post-header’ into the Search box and then ‘Return’"}, { "point": "Insert the Yum Button HTML code immediately after the </div> following the 'post-header-line-1' section as shown in the screenshot below. There will likely be 2 instances of this post-header code, so make sure to add the Yum button code after both instances."}, { "point": 'Select Preview to view the Yum Button is displaying properly and then Save Template.  '}]}, { "text": [{ "textline": 'Wordpress.org', "fontweight": 700}], "points": [{ "point": 'Open your Wordpress site Editor feature (in the Appearance menu) and locate your post or content php template files'}, { "point": 'Identify where you would like to position the Yum Button within your recipe page.'}, { "point": 'Copy & paste  the HTML code for Wordpress.org blogs from here into the appropriate .php file based on where you intend for the Yum Button to appear on your site.'},{ "point": 'Select Update File and view your blog to verify the Yum Button is displaying properly.'}]}, { "text": [{ "textline": 'Wordpress.org (Genesis theme):', "fontweight": 700}, { "textline": 'With the Genesis Theme, you can use the Simple Hooks Plugin to easily add the Yum button code to your site. Ellen blogs give a great tutorial on this here:', "link": 'http://ellenblogs.com/how-to-add-just-a-yummly-button-to-your-recipes/'}, { "textline": 'Wordpress.com (non-hosted):', "fontweight": 700}, { "textline": 'If you have a wordpress.com blog, you can add the Yum button within Sharedaddy via Jetpack (the default sharing option).'}], "points": [{ "point":'In your wordpress blog dashboard, go to Settings>>Sharing.'}, { "point":'Click "Add a new service" under Available Services.'}, { "point":'Fill out the form and click Create Share Button.'}, { "point":'Sharing url', "link": 'https://github.com/naaaasty'}, { "point":'Icon url', "link": 'https://github.com/naaaasty'}, { "point":'Drag the Yummly button down to Enabled Services.'}, { "point":'Click Save Changes at the bottom of the page.'}]}, { "text": [{ "textline": '*Note: The above method does not allow for an image preview when the Yum button is clicked, but the image will show up on the recipe on Yummly once processed.'}, { "textline": 'Squarespace', "fontweight": 700}], "points": [{ "point": "Grab the Yum button code after selecting the option for 'other'."}, { "point": 'Insert the code using a code block on your Squarespage blog by following steps:', "link": 'https://support.squarespace.com/hc/en-us/articles/206543167'}]}, { "text": [{ "textline": 'Adding the Yum button via share plugins/widgets:', "fontweight": 700}, { "textline": 'If you use SumoMe, Shareaholic, AddThis, Po.st, Simple Share Buttons, AddToAny, or E-MAILiT you can add the Yum button as a service.'}], "points": [{ "bold": 'SumoMe:', "point": 'Drag Yummly from the available services list across to the selected services in the plugin settings. (They offer the Yum button via image hover!)'}, { "bold": 'Shareaholic:', "point": 'Just search "Yummly" from their list of sharing services when adding a new button to the lineup', "link": 'https://www.shareaholic.com/publishers'}, { "bold": 'AddThis:', "point": 'Within the Share button settings, choose "Select your own". Search for Yummly, then drag it over to the selected services box.'}, { "bold": 'Simple Share Buttons:', "point": 'Use either their "plus" version or their free Wordpress plugin and add Yummly via their lineup of button options.'}, { "bold": 'Po.st:', "point": 'When you are in settings of the WordPress plugin scroll until you see the sharing channels available. Add the Yum button to your tool and click Save changes.'}, { "bold": 'AddToAny:', "point": 'Click "customize" and find Yummly in the additional sharing options (listed alphabetically)'}, { "bold": 'E-MAILiT:', "point": 'Select Yummly from their sharing menu.'}]}, { "text": [{ "textline": 'If you use another sharing plugin and Yummly doesn’t show up, you can contact them and ask them to add us!'}], "points": [{ "point": 'Sharethis', "mail": 'support@sharethis.com'}]}]
    },
    {
        "idPage": 'plugins-yumm-butt',
        "title": 'Adding the Yum button via plugins',
        "way": [{ "wayname": 'Publisher Help Topics', "link": 'categories/publisher-help-topics'}],
        "data": [{ "text": [{ "textline": 'If you install the Yummly Rich Recipes wordpress plugin, a Yum button is automatically added to your formatted recipe.'}, { "textline": 'If you use SumoMe, Shareaholic, AddThis, Po.st, Simple Share Buttons, AddToAny, or E-MAILiT you can add the Yum button as a service.'}], "points": [{ "bold": 'SumoMe:', "point": 'Drag Yummly from the available services list across to the selected services in the plugin settings. (They offer the Yum button via image hover!)'}, { "bold": 'Shareaholic:', "point": 'Just search "Yummly" from their list of sharing services when adding a new button to the lineup', "link": 'https://www.shareaholic.com/publishers'}, { "bold": 'AddThis:', "point": 'Within the Share button settings, choose "Select your own". Search for Yummly, then drag it over to the selected services box.'}, { "bold": 'Simple Share Buttons:', "point": 'Use either their "plus" version or their free Wordpress plugin and add Yummly via their lineup of button options.'}, { "bold": 'Po.st:', "point": 'When you are in settings of the WordPress plugin scroll until you see the sharing channels available. Add the Yum button to your tool and click Save changes.'}, { "bold": 'AddToAny:', "point": 'Click "customize" and find Yummly in the additional sharing options (listed alphabetically)'}, { "bold": 'E-MAILiT:', "point": 'Select Yummly from their sharing menu.'}]}, { "text": [{ "textline": 'If you use another sharing plugin and Yummly doesn’t show up, you can contact them and ask them to add us!'}], "points": [{ "point": 'Sharethis', "mail": 'support@sharethis.com'}]}, { "text": [{ "textline": 'Sharedaddy on wordpress.com blogs:', "fontweight":700}, { "textline": 'If you have a wordpress.com blog, you can add the Yum button within Sharedaddy via Jetpack (the default sharing option).'}], "points": [{ "point":'In your wordpress blog dashboard, go to Settings>>Sharing.'}, { "point":'Click "Add a new service" under Available Services.'}, { "point":'Fill out the form and click Create Share Button.'}, { "point":'Sharing url', "link": 'https://github.com/naaaasty'}, { "point":'Icon url', "link": 'https://github.com/naaaasty'}, { "point":'Drag the Yummly button down to Enabled Services.'}, { "point":'Click Save Changes at the bottom of the page.'}]}, { "text": [{ "textline": '*Note: The above method does not allow for an image preview when the Yum button is clicked, but the image will show up on the recipe on Yummly once processed.'}, { "textline": 'If you have any trouble adding or using the Yum button, send a request to our support team and include the url of your site, and any other pertinent links, details, and screenshots.'}]}]
    },
    {
...
const section = [
    ...
    {
        own: 'getting-started',
        list: [{ "name": "What's included in my Yummly subscription?", "link": 'including-sub'}, { "name": 'Am I automatically enrolled in the paid subscription?', "link": 'auto-enrolled-in-paid-sub'}, { "name": 'Does my subscription include a Yummly® Smart Thermometer?', "link": 'sub-include-thermomter'}, { "name": 'Do I need a subscription to use my Yummly® Smart Thermometer?', "link": 'do-i-need-a-sub-to-use-thermometer'}, { "name": 'Why is subscription not available in my region?', "link": "why-sub-isn't-available-in-my-region"}, { "name": "What's so special about Yummly's subscriber-only recipes?", "link": 'only-for-subs-recipes'}, { "name": 'Tell me more about the Yummly Meal Planner.', "link": 'more-about-the-meal-planner'}]
    },
    {
        own: 'subs-and-payments',
        list: [{ "name": "I'm a subscriber and don't want to renew my subscription. What do I do?", "link": 'do-not-want-to-renew-sub'}, { "name": 'How much does a Yummly subscription cost?', "link": 'sub-cost'}, { "name": 'Will I be charged if I cancel before the free trial is over?', "link": 'free-trial-sub'}, { "name": 'If I cancel before the free trial is over, can I still access content?', "link": 'if-i-cancel-before-the-free-trial-sub'}, { "name": 'Does my subscription automatically renew?', "link": "does-my-sub-renew-auto"}, { "name": "How do I update my payment method through the web?", "link": 'update-payment-through-the-web'}]
    },
    {
        own: 'yummly-pro-recipes',
        list: [{ "name": "What are Yummly Pro recipes?", "link": 'what-are-yummly-pro-recipes'}, { "name": 'How do Yummly Pro videos work?', "link": 'how-do-yummly-pro-videos-work'}, { "name": 'Do Yummly Pro recipes work on my device?', "link": 'do-yummly-pro-recipes-work-on-my-device'}, { "name": 'Do Yummly Pro recipes work with my Whirlpool connected oven?', "link": 'work-with-whirlpool'}]
    },
    {
        own: 'nift-gift-card',
    ...
    },
    {
        ...
        list : [{ "name": 'What is Yummly?', "link": 'what-is-yummly'}, { "name": 'How to use Yummly', "link": 'how-to-use-yummly'}, { "name": 'Adding recipes to Yummly from other sites', "link": 'adding-recipes-to-yummly-from-other-sites'}, { "name": 'Discovering recipes', "link": 'discovering-recipes'}, { "name": 'Website Recipe search', "link": 'web-search-recipe'}, { "name": 'Recipe box', "link": 'recipe-box'}]
    },
    {
    ...
    },
    {
        ...
        list: [{ "name": 'iOS app Basic troubleshooting', "link": 'ios-and-basic-troubleshooting'}, { "name": 'Home Feed', "link": 'ios-home-feed'}, { "name": 'Sign-in issues', "link": 'ios-sign-in-issue'}, { "name": 'Adding new recipes to the Yummly app from a website', "link": 'ios-adding-new-recipes-from-website'}, { "name": 'My saved recipes are missing', "link": 'ios-saved-recipes-missing'}]
    },
    {
        own: 'ios-meal-planner',
        list: [{ "name": 'How do I use the Yummly Meal Planner?', "link": 'ios-use-meal-planner'}, { "name": 'Where can I find the Meal Planner?', "link": 'ios-find-meal-planner'}, { "name": 'Where do my Meal Plan recommendations come from?', "link": 'ios-meal-recomm-from'}, { "name": 'How do I find out more about a recipe in my Meal Plan recommendations?', "link": 'ios-find-out-more-rec-recomm'}, { "name": 'Do you have any meal planning tips for me?', "link": 'ios-tips-meal-planning'}]
    },
    {
        own: 'ios-shopping-list',
        list: [{ "name": 'Shopping List Overview', "link": 'ios-shopping-list-overview'}, { "name": 'Can I buy ingredients through Yummly?', "link": 'ios-buy-ingr-yummly'}, { "name": 'Can I access my Shopping List on different devices?', "link": 'ios-diff-devices-shopping-list'}, { "name": 'How do I move ingredients to a different shopping aisle?', "link": 'ios-move-ingr-to-a-diff-shopping-list'}]
    },
    {
    ...
    },
    {
        ...
        list: [{ "name": 'What is Virtual Pantry?', "link": "android-virtual-pantry"}, { "name": 'How does Virtual Pantry save me money?', "link": 'android-how-does-vr-pantry-money'}, { "name": 'How does Yummly know when my ingredients are Running Low or Expiring?', "link": 'android-yummly-running-low-or-expiring'}, { "name": 'Can I access my Virtual Pantry from other devices?', "link": 'android-acces-from-other-devices'}, { "name": 'How do the Shopping List and Virtual Pantry work together?', "link": 'android-shopping-list-and-vr-pantry'}]
    },
    {
        own: 'yummly-for-publishers',
        list: [{ "name": 'How Yummly works', "link": 'how-yummly-works'}, { "name": 'Get discovered even faster', "link": 'get-discovered'}, { "name": 'Best practices/guidelines', "link": 'best-practices-guidelines'}, { "name": 'How to add the Yum button to your site', "link": 'yumm-butt-ur-site'}, { "name": 'Adding the Yum button via plugins', "link": 'plugins-yumm-butt'}, { "name": 'Add the Yum button via image hover', "link": 'yumm-butt-via-img-hover'}]
    }
]
