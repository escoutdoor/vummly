									...
									<div className={s.location} onClick={(e) => e.stopPropagation()}>
										<div className={s.locationItem}>
											...
											<p
												...
												className={activeCity ? `${s.locationTextCity} ${s.active}` : s.locationTextCity}>
												{city || 'City'}
											</p>
										</div>
										,
										<div className={s.locationItem}>
											...
											<p
												...
												className={activeCountry ? `${s.locationTextCountry} ${s.active}` : s.locationTextCountry}>
												{country || 'Country'}
											</p>
										</div>
									</div>
					...
					{isMe ? (
						<div className={s.navigation}>
							<ul className={s.navbar}>
								<li onClick={() => setSection('saved recipes')} className={section === 'saved recipes' ? `${s.navbar__item} ${s.active}` : s.navbar__item}>
									saved recipes
								</li>
								<li onClick={() => setSection('preferences')} className={section === 'preferences' ? `${s.navbar__item} ${s.active}` : s.navbar__item}>
									preferences
								</li>
								<li onClick={() => setSection('settings')} className={section === 'settings' ? `${s.navbar__item} ${s.active}` : s.navbar__item}>
									settings
								</li>
							</ul>
