...
const SubmitRequest = () => {
	...
	const sendForm = async e => {
		e.preventDefault()
		;(await info) && !emailError && !subjectError && !descriptionError && browser && !urlError
			? emailjs.sendForm('service_h7toabu', 'template_7g83q57', form.current, 'dQJDPMl6oL-bM1aSW').then(
					result => {
				...
				<form ref={form} className={styles.submitBody} onSubmit={sendForm}>
					...
					<div className={styles.submitInputs}>
						...
						<div className={styles.subInput}>
							...
							<span className={styles.subInput__underDesc}>
						...
						<div className={styles.subInput}>
							...
							<span className={styles.subInput__underDesc}>
								Please enter the details of your request. You can attach a screen shot below if that helps explain a problem you are seeing. Have an idea you want to share with the
								Yummly community? Share it here. A member of our support staff will respond as soon as possible.
							</span>
						...
						<div className={styles.submitInputs__attachment}>
							<label className={styles.subInput__title} data-end={'(optional)'}>
								Attachments
							</label>
